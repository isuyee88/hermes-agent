/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7a13737a45f0b5689b4aa8359589d809)
// Runtime types generated with workerd@1.20260415.1 2026-04-14 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "FeishuReconcileQueue" | "SitePrefetchCache";
	}
	interface Env {
		MODEL_CATALOG_DB: D1Database;
		FEISHU_GATEWAY_ANALYTICS: AnalyticsEngineDataset;
		FEISHU_GATEWAY_KPI_ROLLUPS: AnalyticsEngineDataset;
		MODEL_CATALOG_QUEUE: Queue;
		BROWSER: Fetcher;
		HONEYCOMB_DATASET: "hermes-feishu-gateway";
		FEISHU_API_BASE: "https://open.feishu.cn";
		FEISHU_ACK_REACTION_EMOJI: "OK";
		...
		HERMES_MODEL_CATALOG_ROUTE_PUBLISH_ENABLED: "true";
		HERMES_MODEL_CATALOG_ROUTE_MAX_MODELS: "4";
		HERMES_MODEL_CATALOG_MIN_HEALTH_SCORE: "45";
		HERMES_MODEL_CATALOG_MAX_NEGATIVE_FEEDBACK_COUNT: "3";
		HERMES_MODEL_CATALOG_MAX_AUTH_ERROR_COUNT: "1";
		HERMES_MODEL_CATALOG_MAX_MODEL_NOT_FOUND_COUNT: "1";
		HERMES_MODEL_CATALOG_MAX_RATE_LIMIT_COUNT: "3";
		HERMES_MODEL_CATALOG_RATE_LIMIT_COOLDOWN_SECONDS: "900";
		HERMES_CF_DYNAMIC_ROUTE_EXECUTION_ENABLED: "true";
		HERMES_CF_PROVIDER_ROUTE_LIMITS_JSON: "{\"openrouter\":{\"limit\":45,\"interval\":60,\"technique\":\"sliding\",\"key\":\"metadata.gateway_route_name\"},\"nvidia\":{\"limit\":20,\"interval\":60,\"technique\":\"sliding\",\"key\":\"metadata.gateway_route_name\"}}";
		HERMES_CF_GATEWAY_PROVIDER_SLUGS_JSON: "{\"nvidia\":\"nvidia\"}";
		HERMES_MODEL_CATALOG_QUEUE_ENABLED: "true";
		HERMES_MODEL_CATALOG_QUEUE_DELAY_SECONDS: "3600";
		HERMES_MODEL_CATALOG_QUEUE_RETRY_DELAY_SECONDS: "300";
		HERMES_MODEL_CATALOG_QUEUE_HARD_RETRY_DELAY_SECONDS: "21600";
		HERMES_MODEL_CATALOG_QUEUE_LEASE_SECONDS: "900";
		...
		FEISHU_MODEL_REGISTRY_MAX_MUTATIONS_PER_RUN: "25";
		FEISHU_MODEL_REGISTRY_STALE_DELETE_AFTER_SECONDS: "86400";
		FEISHU_MODEL_REGISTRY_CONTINUE_DELAY_SECONDS: "15";
		...
		FEISHU_RECONCILE_QUEUE: DurableObjectNamespace<import("./src/index").FeishuReconcileQueue>;
		SITE_PREFETCH_CACHE: DurableObjectNamespace<import("./src/index").SitePrefetchCache>;
		FEISHU_AGENT_WORKFLOW: Workflow<Parameters<import("./src/index").FeishuAgentWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HONEYCOMB_DATASET" | "FEISHU_API_BASE" | "FEISHU_ACK_REACTION_EMOJI" | "MODAL_INTERNAL_BASE_URL" | "HERMES_MODEL_CATALOG_SYNC_ENABLED" | "HERMES_MODEL_CATALOG_SYNC_PROVIDERS" | "HERMES_MODEL_CATALOG_ROUTE_PUBLISH_ENABLED" | "HERMES_MODEL_CATALOG_ROUTE_MAX_MODELS" | "HERMES_MODEL_CATALOG_MIN_HEALTH_SCORE" | "HERMES_MODEL_CATALOG_MAX_NEGATIVE_FEEDBACK_COUNT" | "HERMES_MODEL_CATALOG_MAX_AUTH_ERROR_COUNT" | "HERMES_MODEL_CATALOG_MAX_MODEL_NOT_FOUND_COUNT" | "HERMES_MODEL_CATALOG_MAX_RATE_LIMIT_COUNT" | "HERMES_MODEL_CATALOG_RATE_LIMIT_COOLDOWN_SECONDS" | "HERMES_CF_DYNAMIC_ROUTE_EXECUTION_ENABLED" | "HERMES_CF_PROVIDER_ROUTE_LIMITS_JSON" | "HERMES_CF_GATEWAY_PROVIDER_SLUGS_JSON" | "HERMES_MODEL_CATALOG_QUEUE_ENABLED" | "HERMES_MODEL_CATALOG_QUEUE_DELAY_SECONDS" | "HERMES_MODEL_CATALOG_QUEUE_RETRY_DELAY_SECONDS" | "HERMES_MODEL_CATALOG_QUEUE_HARD_RETRY_DELAY_SECONDS" | "HERMES_MODEL_CATALOG_QUEUE_LEASE_SECONDS" | "HERMES_FEISHU_KPI_QUEUE_ENABLED" | "HERMES_FEISHU_KPI_QUEUE_DELAY_SECONDS" | "HERMES_FEISHU_KPI_QUEUE_RETRY_DELAY_SECONDS" | "HERMES_FEISHU_KPI_QUEUE_HARD_RETRY_DELAY_SECONDS" | "HERMES_FEISHU_KPI_QUEUE_LEASE_SECONDS" | "FEISHU_MODEL_REGISTRY_MIRROR_ENABLED" | "FEISHU_MODEL_REGISTRY_MAX_MUTATIONS_PER_RUN" | "FEISHU_MODEL_REGISTRY_STALE_DELETE_AFTER_SECONDS" | "FEISHU_MODEL_REGISTRY_CONTINUE_DELAY_SECONDS" | "FEISHU_BITABLE_TABLE_NAME" | "HERMES_CF_TEXT_PLAIN_ROUTE_NAME" | "HERMES_CF_TEXT_CODING_ROUTE_NAME">> {}
}
